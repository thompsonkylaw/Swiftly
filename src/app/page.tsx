    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans overflow-hidden relative">
      ...
      <main className="relative max-w-7xl mx-auto px-6 pt-16 pb-24 flex flex-col items-center justify-center min-h-[80vh]">
        ...
        <div className="absolute inset-0 pointer-events-none hidden lg:block">
            ...
            <div className="absolute bottom-[20%] right-[10%] bg-white p-4 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-gray-100 w-80 rotate-[-2deg] animate-float-medium">
                ...
                <div className="mt-3 pl-12 flex gap-2">
                 ...
                 <div className="absolute -bottom-20 -right-20 pointer-events-auto">
                     {showPopup && (
                        <div className="absolute bottom-full right-0 mb-4 w-64 bg-white p-4 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-gray-100 text-sm text-gray-800 animate-slide-up origin-bottom-right">
                             ...
                             Schools replace 3+ platforms when they switch to Swiftly. <br /><span className="font-semibold">Amazing, right?</span>
                        </div>
                     )}
                    <button className="w-14 h-14 bg-teal-500 rounded-full shadow-lg flex items-center justify-center text-white hover:bg-teal-600 transition-colors transform hover:scale-105 active:scale-95">
